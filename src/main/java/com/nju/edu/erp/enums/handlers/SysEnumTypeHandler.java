...
@MappedTypes(value = {PurchaseSheetState.class, WarehouseInputSheetState.class,
        WarehouseOutputSheetState.class, CustomerType.class, SaleSheetState.class,
        PurchaseReturnsSheetState.class, SaleReturnsSheetState.class, ReceiptSheetState.class,
        PaymentSheetState.class, SalarySheetState.class, Gender.class})
