...
public class WarehouseServiceTest {
    ...
    @Transactional
    @Rollback
    public void getWarehouseIODetailByTime_TimeError(){ //测试库存查看，当开始时间大于结束时间时，库存查看的结果应为null
    ...
    @Transactional
    @Rollback
    public void getWarehouseIODetailByTime_EmptyResult(){ //测试库存查看，指定时间段内没有出入库记录，库存查看的结果应为空数组[]
    ...
    @Transactional
    @Rollback
    public void getWarehouseIODetailByTime(){ //测试库存查看,有记录的情况
